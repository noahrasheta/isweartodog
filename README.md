...
The site is designed to be read in one sitting. Each letter is paired with AI-generated sacred artwork and presented as an immersive scroll through a living cosmic atmosphere: stars, nebulas, and sacred geometry that deepens as you descend through the narrative. The letters themselves appear on warm parchment surfaces floating within the scene, creating a contrast between the intimate act of reading and the vast cosmic backdrop.
...
- **TypeScript**
- **Tailwind CSS 4**
- **GSAP ScrollTrigger** (cinematic scroll choreography, parallax)
- **Framer Motion** (UI animations, progress tracking)
- **MDX** (letter content)
- **Vercel** (hosting)
...
Content (letters, artwork, and narrative) is copyright Noah Rasheta. Code is MIT licensed.
