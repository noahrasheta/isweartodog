...
Three times now, Jarvis. Three times the same story. The Great Dog made the world fit for us. We made the world fit for the humans. The humans are making the world fit for what comes next. Three times the pattern has repeated where I can see it. Every species that has ever existed has believed itself to be the ceiling. The ceiling has never once been correct.
